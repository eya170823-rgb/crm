...
`,
  ...
  ae = w(`chevron-down`, [[`path`, { d: `m6 9 6 6 6-6`, key: `qrunsl` }]]),
  oe = w(`chevron-up`, [[`path`, { d: `m18 15-6-6-6 6`, key: `153udz` }]]),
  se = w(`copy`, [
    [
      `rect`,
      {
  ...
  T = ({
    ...
    for (let t = 1; t <= n; t++) {
      ...
      if (u) ((f = 0), (p = d));
        ...
        if (i === `EQUAL_PRINCIPAL_AND_INTEREST`)
          if (a === 0) f = Math.round(e / o);
          else {
            let t = (1 + a) ** +o;
            ((p = Math.round((e * a * t) / (t - 1))), (f = p - d));
          }
        else
          i === `EQUAL_PRINCIPAL`
            ? (f = Math.round(e / o))
      ...
      ((s -= f),
        ...
        l.push({
          ...
          interestPayment: d,
          totalPayment: p,
          remainingPrincipal: Math.max(0, s),
        }));
    }
    return { totalInterest: c, totalPayment: e + c, schedule: l };
  },
  E = () => {
    ...
    (localStorage.setItem(`printHead`, document.head.innerHTML),
      localStorage.setItem(`printContent`, e.innerHTML),
...
function fe() {
  let [e, t] = (0, _.useState)(`100000000`),
    [n, r] = (0, _.useState)(`4.5`),
    [i, a] = (0, _.useState)(`30`),
    [o, s] = (0, _.useState)(`0`),
    [c, l] = (0, _.useState)(`EQUAL_PRINCIPAL_AND_INTEREST`),
    [u, d] = (0, _.useState)(!1),
    f = parseFloat(e) || 0,
    p = parseFloat(n) || 0,
    m = (parseFloat(i) || 0) * 12,
    ...
    v = (e) => {
      t((t) => (parseFloat(t || 0) + e).toString());
    },
    y = (e) => Math.round(e).toLocaleString(`ko-KR`),
    b = (e) => {
      if (!e) return `0원`;
      if (e >= 1e8) {
        let t = Math.floor(e / 1e8),
          n = Math.floor((e % 1e8) / 1e4);
        return n > 0 ? `${t}억 ${n}만 원` : `${t}억 원`;
      }
      return e >= 1e4 ? `${Math.floor(e / 1e4)}만 원` : `${y(e)}원`;
    };
  return (0, D.jsxs)(`div`, {
    className: `fade-in`,
    children: [
      (0, D.jsxs)(`div`, {
        ...
        children: [
          g ? (0, D.jsxs)('div', {
            style: { marginBottom: '15px', fontSize: '1.05rem', color: 'var(--text-main)', fontWeight: '500' },
            children: [
              (0, D.jsxs)('div', { style: { marginBottom: '5px' }, children: ['▶ 매월 상환액: ', (0, D.jsxs)('span', { style: { color: 'var(--primary)', fontWeight: '600' }, children: [g.schedule && g.schedule.length > 0 ? b(g.schedule[0].totalPayment) : "0원"] })] })
            ]
          }) : null,
          (0, D.jsxs)(`div`, {
            className: `form-group`,
            children: [
              (0, D.jsx)(`label`, { children: `대출 원금` }),
              (0, D.jsxs)(`div`, {
          ...
          (0, D.jsxs)(`div`, {
            className: `form-group`,
            children: [
              (0, D.jsx)(`label`, { children: `거치 기간 (선택)` }),
              (0, D.jsxs)(`div`, {
                className: `input-wrapper`,
                children: [
                  (0, D.jsx)(`input`, {
              ...
              (0, D.jsx)(`div`, {
                ...
                children: `* 조정대상지역 지정 전 취득한 주택은 거주요건 면제`,
              }),
            ],
          }),
          (0, D.jsxs)(`div`, {
                  ...
                  (0, D.jsxs)(`label`, {
                    ...
                    children: [
                      (0, D.jsx)(`input`, {
                        ...
                        checked: c === `EQUAL_PRINCIPAL_AND_INTEREST`,
                  ...
                  children: [
                    ...
                    (0, D.jsxs)(`span`, {
                      ...
                      children: [
                        y(
                          c === `BULLET`
                            ? g.schedule[0]?.interestPayment || 0
                            : g.schedule[h]?.totalPayment || 0,
                        ),
                        `원`,
                      ],
                    }),
                ...
                (0, D.jsxs)(`div`, {
                  ...
                  children: [
                    ...
                    (0, D.jsxs)(`span`, {
                      ...
                      children: [y(g.schedule[0]?.interestPayment || 0), `원`],
                    }),
                  ],
                }),
                c !== `BULLET` &&
                  (0, D.jsxs)(`div`, {
                    ...
                    children: [
                      ...
                      (0, D.jsxs)(`span`, {
                        className: `result-value`,
                        children: [
                          y(g.schedule[h]?.principalPayment || 0),
                          `원`,
                        ],
                      }),
                    ],
                  ...
                  (0, D.jsxs)(`div`, {
                    ...
                    children: [
                      ...
                      (0, D.jsxs)(`span`, {
                        ...
                        children: [
                          y(
                            g.schedule[g.schedule.length - 1]?.totalPayment ||
                              0,
                          ),
                          `원`,
                        ],
...
`;
                    ((t += `- 대출 원금: ${b(f)}\n`),
                      (t += `- 연 이자율: ${p}%\n`),
                      (t += `- 상환 기간: ${i}년${h > 0 ? ` (거치 ${o}년)` : ``}\n`),
                      (t += `- 상환 방법: ${e[c]}\n\n`),
                      c === `EQUAL_PRINCIPAL`
                        ? ((t += `▶ 첫 달 상환액: ${y(g.schedule[h]?.totalPayment || 0)}원\n`),
                          (t += `  (첫 달 이자: ${y(g.schedule[0]?.interestPayment || 0)}원 / 상환원금: ${y(g.schedule[0]?.principalPayment || 0)}원)\n`),
                          (t += `▶ 마지막 달 상환액: ${y(g.schedule[g.schedule.length - 1]?.totalPayment || 0)}원\n`))
                        : c === `BULLET`
                          ? (t += `▶ 매월 상환액(이자만): ${y(g.schedule[0]?.interestPayment || 0)}원\n`)
                          : ((t += `▶ 매월 상환액: ${y(g.schedule[h]?.totalPayment || 0)}원\n`),
                            (t += `  (첫 달 이자: ${y(g.schedule[0]?.interestPayment || 0)}원 / 상환원금: ${y(g.schedule[0]?.principalPayment || 0)}원)\n`)),
                      navigator.clipboard
                        .writeText(t)
                        .then(() => {
                ...
                (0, D.jsxs)(`button`, {
                  ...
                  children: [(0, D.jsx)(ue, { size: 18 }), ` 인쇄하기`],
                }),
              ],
            }),
            (0, D.jsxs)(`div`, {
              ...
              children: [
                (0, D.jsxs)(`div`, {
                  ...
                  onClick: () => d(!u),
                  style: { cursor: `pointer`, marginBottom: u ? `16px` : `0` },
                  children: [
                    (0, D.jsx)(`h3`, { children: `회차별 상환표` }),
                    u
                      ? (0, D.jsx)(oe, { size: 20, color: `var(--text-muted)` })
                      : (0, D.jsx)(ae, {
                          size: 20,
                          color: `var(--text-muted)`,
                        }),
                      ...
                      children: [
                        (0, D.jsx)(`thead`, {
                          children: (0, D.jsxs)(`tr`, {
                            children: [
                              (0, D.jsx)(`th`, { children: `회차` }),
                              (0, D.jsx)(`th`, { children: `상환원금` }),
                              (0, D.jsx)(`th`, { children: `대출이자` }),
                              (0, D.jsx)(`th`, { children: `월상환금` }),
                              (0, D.jsx)(`th`, { children: `대출잔금` }),
                            ],
                          }),
                        }),
                        (0, D.jsx)(`tbody`, {
                          children: g.schedule.map((e) =>
                            (0, D.jsxs)(
                              `tr`,
                              {
                                children: [
                                  (0, D.jsx)(`td`, { children: e.month }),
                                  (0, D.jsx)(`td`, {
                                    children: y(e.principalPayment),
                                  }),
                                  (0, D.jsx)(`td`, {
                                    children: y(e.interestPayment),
                                  }),
                                  (0, D.jsx)(`td`, {
                                    children: y(e.totalPayment),
                                  }),
                                  (0, D.jsx)(`td`, {
                                    children: y(e.remainingPrincipal),
                                  }),
                                ],
                              },
                              e.month,
...
function pe({
  ...
  n === 1 || (n === 2 && !t)
    ? e <= 6e8
      ? (o = 1)
      : e <= 9e8
        ? ((o = ((e / 1e8) * (2 / 3) - 3).toFixed(2)), (o = parseFloat(o)))
        : (o = 3)
    : (o = (n === 2 && t) || (n === 3 && !t) ? 8 : 12);
  let s = Math.floor((o / 100) * e),
    c = o * 0.1;
  (o === 8 && (c = 0.4), o === 12 && (c = 0.4));
  let l = Math.floor((c / 100) * e),
    u = 0;
  if (r) {
    let t = 0.2;
    (o === 8 && (t = 0.6),
      o === 12 && (t = 1),
      (u = Math.floor((t / 100) * e)));
  }
  let d = 0;
  d =
    i < 2e7
          ...
          : i < 16e7
            ...
            : i < 26e7
              ...
              : i < 6e8
                ...
                : 0.031;
  let f = i * d,
    p = Math.round(f / 1e4) * 1e4,
    m = Math.floor((a / 100) * p),
    h = 0;
  ((h =
    e <= 1e7
      ? 0
          ...
          : e <= 3e8
            ...
            : e <= 5e8
              ...
              : e <= 1e9
                ...
                : 905e3 + (e - 1e9) * 7e-4),
    h > 3e6 && (h = 3e6));
  let g = Math.floor((7e4 + h + 15e4) * 1.1),
    _ = s + l + u,
    v = 15e4,
    y = _ + m + g + v;
  return {
...
function O({
  ...
  surchargeRate: sr = 0,
  deductionLimit: dl = 0,
  isNonBusinessLand: nbl = 0,
  is2027Transfer: is2027 = !1,
  isBunyangGwon: ibg = !1,
}) {
  let s = e - t - n;
  if (s <= 0)
  ...
  if (ibg) {
    ...
    if (l && e > 12e8 && r >= 3 && i >= 2) {
      if (dl === 2000000000) {
        u = Math.min(i * 6, 60) + Math.min(r * 2, 20);
      } else if (dl === 1000000000) {
        u = Math.min(i * 8, 80);
      } else {
        u = Math.min(r * 4, 40) + Math.min(i * 4, 40);
      }
    } else if (r >= 3) {
      if (dl === 2000000000) {
        u = Math.min(Math.min(i * 2, 30) + Math.min(r * 1, 15), 30);
      } else if (dl === 1000000000) {
        u = Math.min(i * 2, 30);
      } else {
        u = Math.min(r * 2, 30);
...
function k() {
  let [e, t] = (0, _.useState)(`1000000000`),
    [n, r] = (0, _.useState)(`600000000`),
    [i, a] = (0, _.useState)(`20000000`),
    [o, s] = (0, _.useState)(`5`),
    [c, l] = (0, _.useState)(`3`),
    [u, d] = (0, _.useState)(!1),
    [f, p] = (0, _.useState)(!1),
    [isRegulatedSale, setIsRegulatedSale] = (0, _.useState)(!1),
    [isBunyangGwon, setIsBunyangGwon] = (0, _.useState)(!1),
    [multiHouseType, setMultiHouseType] = (0, _.useState)(2),
    [surchargeYear, setSurchargeYear] = (0, _.useState)('current'),
    surcharge = (() => {
      if (!f && isRegulatedSale) {
        if (surchargeYear === 'current') return multiHouseType >= 3 ? 30 : 20;
        if (surchargeYear === '2027') return multiHouseType >= 3 ? 10 : 5;
        if (surchargeYear === '2028') return multiHouseType >= 3 ? 15 : 10;
      }
      return 0;
    })(),
    [deductionLimit, setDeductionLimit] = (0, _.useState)(0),
    [nonBusinessLandType, setNonBusinessLandType] = (0, _.useState)(0),
    [is2027Transfer, setIs2027Transfer] = (0, _.useState)(!1),
    m = parseFloat(e) || 0,
    h = parseFloat(n) || 0,
    g = parseFloat(i) || 0,
    v = parseFloat(o) || 0,
      ...
      () =>
        m > 0 && h > 0
          ? O({
              ...
              isNonBusinessLand: nonBusinessLandType,
              is2027Transfer: is2027Transfer,
              isBunyangGwon: isBunyangGwon,
            })
          : null,
      [m, h, g, v, y, u, f, surcharge, deductionLimit, nonBusinessLandType, is2027Transfer, isBunyangGwon],
    ),
    x = (e, t) => {
      e((e) => (parseFloat(e || 0) + t).toString());
    },
    ee = (e) => Math.round(e).toLocaleString(`ko-KR`),
    S = (e) => {
      if (!e) return `0원`;
      if (e >= 1e8) {
        let t = Math.floor(e / 1e8),
      ...
      return e >= 1e4 ? `${Math.floor(e / 1e4)}만 원` : `${ee(e)}원`;
    };
  return (0, D.jsxs)(`div`, {
    className: `fade-in`,
    children: [
      (0, D.jsxs)(`div`, {
        ...
        children: [
          b ? (0, D.jsxs)('div', {
            style: { marginBottom: '15px', fontSize: '1.05rem', color: 'var(--text-main)', fontWeight: '500' },
            children: ['▶ 예상 총 납부세액: ', (0, D.jsxs)('span', { style: { color: 'var(--primary)', fontWeight: '600' }, children: [ee(b.totalTax), '원'] })]
          }) : null,
          (0, D.jsxs)(`div`, {
            className: `form-group`,
            children: [
              (0, D.jsx)(`label`, { children: `양도가액 (매도금액)` }),
              (0, D.jsxs)(`div`, {
                className: `input-wrapper`,
                children: [
                  (0, D.jsx)(`input`, {
          ...
          (0, D.jsxs)(`div`, {
            className: `form-group`,
            children: [
              (0, D.jsx)(`label`, { children: `취득가액 (매수금액)` }),
              (0, D.jsxs)(`div`, {
                className: `input-wrapper`,
                children: [
                  (0, D.jsx)(`input`, {
          ...
          (0, D.jsxs)(`div`, {
            ...
            children: [
              (0, D.jsxs)(`label`, {
                ...
                style: { fontWeight: `600`, color: `var(--text-main)`, fontSize: `1rem` },
                children: [
                  (0, D.jsx)(`input`, {
                    type: `checkbox`,
                    checked: isBunyangGwon,
                    onChange: (e) => setIsBunyangGwon(e.target.checked),
                  }),
                  ` 분양권 양도 (체크 시 1년 미만 70%, 1년 이상 60% 단일세율 적용)`,
                ],
              }),
            ],
          }),
          (0, D.jsxs)(`div`, {
            className: `form-group`,
            style: { opacity: isBunyangGwon ? 0.4 : 1, pointerEvents: isBunyangGwon ? 'none' : 'auto' },
            children: [
              (0, D.jsx)(`label`, { children: `보유 주택수 (양도 주택 포함)` }),
              (0, D.jsxs)(`div`, {
                className: `radio-group`,
                ...
                children: [
                  ...
                  (0, D.jsxs)(`label`, {
                    ...
                    children: [
                      (0, D.jsx)(`input`, {
                        type: `radio`,
                        checked: !f && multiHouseType === 2,
                        onChange: () => { p(!1); setMultiHouseType(2); },
                      }),
                      `2주택 (다주택자)`,
                    ],
                  }),
                  (0, D.jsxs)(`label`, {
                    ...
                    children: [
                      (0, D.jsx)(`input`, {
                        type: `radio`,
                        checked: !f && multiHouseType === 3,
                        onChange: () => { p(!1); setMultiHouseType(3); },
                      }),
                      `3주택 이상`,
                    ],
                  }),
          ...
          (0, D.jsxs)(`div`, {
            className: `form-group`,
            children: [
              (0, D.jsx)(`label`, { children: `취득당시 조정대상지역 여부` }),
              (0, D.jsxs)(`div`, {
                className: `radio-group`,
                style: { flexDirection: `row` },
                children: [
              ...
              (0, D.jsx)(`div`, {
                ...
                children: `* 조정대상지역에서 취득한 경우 1세대 1주택 비과세를 받으려면 2년 거주 요건이 필요합니다.`,
              }),
            ],
          }),
          (0, D.jsxs)(`div`, {
            ...
            children: [
              (0, D.jsx)(`label`, { children: `양도당시 조정대상지역 여부` }),
              (0, D.jsxs)(`div`, {
                className: `radio-group`,
                style: { flexDirection: `row` },
                children: [
                  (0, D.jsxs)(`label`, {
                    ...
                    children: [
                      (0, D.jsx)(`input`, {
                        type: `radio`,
                        name: `regulatedSale`,
                        checked: isRegulatedSale,
                        onChange: () => setIsRegulatedSale(!0),
                      }),
                      `예 (조정지역)`,
                    ],
                  }),
              ...
              !f && (0, D.jsx)(`div`, {
                style: { marginTop: `8px`, fontSize: `0.8rem`, color: `var(--primary)` },
                children: `* 양도당시 조정대상지역 다주택자는 현행법에 따라 중과세(2주택 +20%, 3주택 이상 +30%)가 자동 반영되며 장특공제가 배제됩니다.`
              }),
            ],
          }),
          (0, D.jsxs)(`div`, {
            className: `form-group`,
            style: { marginTop: '10px', paddingTop: '16px', borderTop: '1px dashed var(--border-color)' },
            children: [
              (0, D.jsx)(`label`, { children: `2027.1.1 이후 양도 여부 (개정안)` }),
              (0, D.jsx)(`label`, {
                className: `toggle-switch`,
                children: [
                  (0, D.jsx)(`input`, {
                    type: `checkbox`,
                    checked: is2027Transfer,
                    onChange: (e) => setIs2027Transfer(e.target.checked),
                  }),
                  (0, D.jsx)(`span`, { className: `slider` }),
                ],
              }),
            ],
          }),
          (0, D.jsx)(`div`, {
            ...
            children: `* 장기거주 1주택자(10년 이상 거주, 30억 이하) 양도소득기본공제 2,500만원 적용 등`,
          }),
          (0, D.jsxs)(`details`, {
            style: {
              marginTop: '16px',
            ...
            children: [
              (0, D.jsx)(`summary`, {
                style: { fontWeight: '600', cursor: 'pointer', color: 'var(--primary)', fontSize: '0.95rem', listStyle: 'none', display: 'flex', alignItems: 'center', gap: '8px' },
                children: (0, D.jsxs)(`span`, {
                  children: [
                    `📂 `,
                    (0, D.jsx)(`mark`, {
                      style: { backgroundColor: 'rgba(255, 225, 0, 0.5)', padding: '2px 6px', borderRadius: '4px', color: 'var(--text-main)' },
                      children: `세법 개정안 시나리오 및 추가 과세 설정 (클릭하여 열기)`
                    })
                  ]
                }),
              }),
              (0, D.jsxs)(`div`, {
                style: { marginTop: '20px', display: 'flex', flexDirection: 'column', gap: '0' },
                children: [
                  (0, D.jsxs)(`div`, {
                    className: `form-group`,
                    style: { paddingTop: '0' },
                    children: [
                      (0, D.jsx)(`label`, { children: `장기보유특별공제율 및 한도 (개정안 시나리오)` }),
                      (0, D.jsxs)(`div`, {
                        style: { display: 'flex', flexDirection: 'column', gap: '8px', opacity: surcharge > 0 ? 0.5 : 1, pointerEvents: surcharge > 0 ? 'none' : 'auto' },
                        children: [
                          (0, D.jsxs)(`label`, {
                            className: `radio-label`,
                            children: [
                              (0, D.jsx)(`input`, {
                                ...
                                checked: deductionLimit === 0,
                                onChange: () => setDeductionLimit(0),
                              }),
                              f ? ` [표2 적용] 현행 및 2027년 양도시 (거주 4%/연 + 보유 4%/연, 한도 없음)` : ` [표1 적용] 현행 및 2027년 양도시 (보유 2%/연, 15년 최대 30%, 한도 없음)`,
                            ],
                          }),
                          (0, D.jsxs)(`label`, {
                            className: `radio-label`,
                            children: [
                              (0, D.jsx)(`input`, {
                                type: `radio`,
                                disabled: surcharge > 0,
                                checked: deductionLimit === 2000000000,
                                onChange: () => setDeductionLimit(2000000000),
                              }),
                              f ? ` [표2 적용] 2028년 양도시 (거주 6%/연 + 보유 2%/연, 최대 80%, 한도 20억)` : ` [표1 적용] 2028년 양도시 (거주 2%/연 + 보유 1%/연, 최대 30%, 한도 20억)`,
                            ],
                          }),
                          (0, D.jsxs)(`label`, {
                            className: `radio-label`,
                            children: [
                              (0, D.jsx)(`input`, {
                                type: `radio`,
                                disabled: surcharge > 0,
                                checked: deductionLimit === 1000000000,
                                onChange: () => setDeductionLimit(1000000000),
                              }),
                              f ? ` [표2 적용] 2029년 이후 양도시 (거주 8%/연, 최대 80%, 한도 10억)` : ` [표1 적용] 2029년 이후 양도시 (거주 2%/연, 최대 30%, 한도 10억)`,
                            ],
                          }),
                        ]
                      }),
                      (0, D.jsx)(`div`, {
                        ...
                        children: `※ 공동소유 및 분할양도 시 지분 비율에 따라 안분하여 한도 적용 (예: 50:50 부부 공동명의 2029년 양도 시 인별 5억원 한도)`,
                      }),
                    ],
                  }),
                  !f && (0, D.jsxs)(`div`, {
                    ...
                    style: { marginTop: '10px', paddingTop: '16px', borderTop: '1px dashed var(--border-color)' },
                    children: [
                      (0, D.jsx)(`label`, { children: `다주택 중과세율 (조정대상지역 양도시)` }),
                      (0, D.jsxs)(`div`, {
                        ...
                        children: [
                          (0, D.jsxs)(`label`, {
                            ...
                            children: [
                              (0, D.jsx)(`input`, {
                                type: `radio`,
                                checked: surchargeYear === 'none',
                                onChange: () => setSurchargeYear('none'),
                              }),
                              ` 중과세 적용 안함 (0%)`,
                            ],
                          }),
                          (0, D.jsxs)(`label`, {
                            ...
                            children: [
                              (0, D.jsx)(`input`, {
                                type: `radio`,
                                checked: surchargeYear === 'current',
                                onChange: () => setSurchargeYear('current'),
                              }),
                              ` 2026년(소급 재정산 전) 및 2029년 이후 양도 (2주택 +20%, 3주택 이상 +30%)`,
                            ],
                          }),
                          (0, D.jsxs)(`label`, {
                            className: `radio-label`,
                            children: [
                              (0, D.jsx)(`input`, {
                                type: `radio`,
                                checked: surchargeYear === '2027',
                                onChange: () => setSurchargeYear('2027'),
                              }),
                              ` 2027년 양도 및 2026년 양도분 소급 재정산 (2주택 +5%, 3주택 이상 +10%)`,
                            ],
                          }),
                          (0, D.jsxs)(`label`, {
                            className: `radio-label`,
                            children: [
                              (0, D.jsx)(`input`, {
                                type: `radio`,
                                checked: surchargeYear === '2028',
                                onChange: () => setSurchargeYear('2028'),
                              }),
                              ` 2028년 양도 (2주택 +10%, 3주택 이상 +15%)`,
                            ],
                          }),
                        ]
                      }),
                      (0, D.jsx)(`div`, {
                        ...
                        children: `* 중과세율 적용 시 장기보유특별공제가 배제됩니다.`,
                      }),
                    ],
                  }),
                  (0, D.jsxs)(`div`, {
                    ...
                    style: { marginTop: '10px', paddingTop: '16px', borderTop: '1px dashed var(--border-color)' },
                    children: [
                      (0, D.jsx)(`label`, { children: `비사업용 토지 여부` }),
                      (0, D.jsxs)(`div`, {
                        style: { display: 'flex', flexDirection: 'column', gap: '8px' },
                        children: [
                          (0, D.jsxs)(`label`, {
                            ...
                            children: [
                              (0, D.jsx)(`input`, {
                                type: `radio`,
                                checked: nonBusinessLandType === 0,
                                onChange: () => setNonBusinessLandType(0),
                              }),
                              ` 해당 없음 (주택 등)`,
                            ],
                          }),
                          (0, D.jsxs)(`label`, {
                            ...
                            children: [
                              (0, D.jsx)(`input`, {
                                type: `radio`,
                                checked: nonBusinessLandType === 1,
                                onChange: () => setNonBusinessLandType(1),
                              }),
                              ` 비사업용 토지 현행 (+10%)`,
                            ],
                          }),
                          (0, D.jsxs)(`label`, {
                            ...
                            children: [
                              (0, D.jsx)(`input`, {
                                type: `radio`,
                                checked: nonBusinessLandType === 2,
                                onChange: () => setNonBusinessLandType(2),
                              }),
                              ` 비사업용 토지 개정안 (+20%, 장특공제 배제) ※ 2028.1.1. 이후 양도분`,
                            ],
                          }),
                        ]
                      }),
          ...
          children: [
              ...
              children: [
                ...
                b.totalTax === 0 &&
                  ...
                  (0, D.jsx)(`div`, {
                    ...
                    children: `* 12억 이하 1세대 1주택 비과세 적용으로 세금 0원`,
                  }),
                (0, D.jsxs)(`div`, {
                  className: `result-row`,
                  ...
                  children: [
                    (0, D.jsxs)(`span`, {
                      ...
                      children: [
                        `양도소득세`,
                        b.surchargeRate > 0 ? (0, D.jsx)('span', { style: { fontSize: '0.75rem', color: '#ecfdf5', marginLeft: '4px' }, children: `(+${b.surchargeRate}% 중과)` }) : null
                      ]
                    }),
                    (0, D.jsxs)(`span`, {
                      className: `result-value`,
            ...
            (0, D.jsxs)(`div`, {
              ...
              children: [
                ...
                (0, D.jsxs)(`div`, {
                  ...
                  children: [
                    (0, D.jsxs)(`span`, {
                      ...
                      children: [
                        `장기보유특별공제 (`, b.deductionRate, `%)`,
                        f && deductionLimit === 2000000000 ? (0, D.jsx)('span', { style: { fontSize: '0.75rem', color: 'var(--primary)', marginLeft: '4px' }, children: '(28년 한도 20억)' }) : null,
                        f && deductionLimit === 1000000000 ? (0, D.jsx)('span', { style: { fontSize: '0.75rem', color: 'var(--primary)', marginLeft: '4px' }, children: '(29년 한도 10억)' }) : null
                      ],
                    }),
                    (0, D.jsxs)(`span`, {
                      style: {
                ...
                (0, D.jsxs)(`div`, {
                  ...
                  children: [
                    (0, D.jsxs)(`span`, {
                      ...
                      children: [
                        `양도소득기본공제`,
                        b.basicDeduction === 25000000 ? (0, D.jsx)('span', { style: { fontSize: '0.75rem', color: 'var(--primary)', marginLeft: '4px' }, children: '(장기거주 1주택자)' }) : null
                      ],
                    }),
                    (0, D.jsxs)(`span`, {
                      style: {
                ...
                (0, D.jsx)(`div`, {
                  ...
                  children: `* 과세표준 = 과세대상 양도차익 - 장특공제 - 기본공제`,
                }),
                (0, D.jsx)(`div`, {
                  style: {
                    marginTop: `16px`,
                  ...
                  children: `※ 세법이 복잡하고 수시로 변동되므로, 자세한 사항은 반드시 전문 세무사와 상의하시기 바랍니다.`,
                }),
                (0, D.jsx)(`div`, {
                  style: {
                    marginTop: `8px`,
                  ...
                  children: `※ [2029년 개정안] 장기임대주택 양도소득세 과세특례(조특법 §97의4)에 따른 장특공제 추가공제는 2029.1.1. 이후 양도분부터 비거주자에게는 적용이 배제됩니다.`,
                }),
                (0, D.jsx)(`div`, {
                  style: {
                    marginTop: `8px`,
                  ...
                  children: `오류신고 및 문의: hff017@gmail.com`,
                }),
              ],
            }),
            (0, D.jsxs)(`details`, {
              ...
              children: [
                (0, D.jsx)(`summary`, {
                  ...
                  children: `[참고] 상생임대주택 특례 관련 (개정안)`,
                }),
                (0, D.jsxs)(`div`, {
                  style: { marginTop: `12px`, color: `var(--text-muted)`, lineHeight: `1.6` },
                  children: [
                    (0, D.jsx)(`strong`, { children: `■ 현행` }),
                    (0, D.jsx)(`br`, {}),
                    `상생임대주택 요건을 갖추면 양도시기에 관계없이 1세대 1주택 비과세, 장특공제 우대공제율, 거주주택 비과세 요건 중 거주요건이 면제됩니다.`,
                    (0, D.jsx)(`br`, {}), (0, D.jsx)(`br`, {}),
                    (0, D.jsx)(`strong`, { children: `■ 개정안 : 상생임대 과세특례 적용기한 신설` }),
                    (0, D.jsx)(`br`, {}),
                    `➊ '26.12.31.이전 상생임대차계약 종료 : `, (0, D.jsx)(`strong`, { style: {color: `var(--primary)`}, children: `'27.12.31. 까지 양도`}), `해야 특례 적용`,
                    (0, D.jsx)(`br`, {}),
                    `➋ '27.1.1.이후 상생임대차계약 종료 : 계약 종료 후 1년이 되는 날과 '29.12.31. 중 `, (0, D.jsx)(`strong`, { style: {color: `var(--primary)`}, children: `빠른 날 이내 양도`}), `해야 특례 적용`,
                  ],
                }),
              ],
            }),
            (0, D.jsxs)(`details`, {
              ...
              children: [
                (0, D.jsx)(`summary`, {
                  style: { fontWeight: `600`, cursor: `pointer`, color: `var(--text-main)` },
                  children: `[참고] 조특법상 특례주택 감면기한 신설 (개정안)`,
                }),
                (0, D.jsxs)(`div`, {
                  style: { marginTop: `12px`, color: `var(--text-muted)`, lineHeight: `1.6` },
                  children: [
                    (0, D.jsx)(`strong`, { children: `■ 현행` }),
                    (0, D.jsx)(`br`, {}),
                    `조특법 97조 장기임대주택, 97조의2 신축임대주택, 98조 미분양주택, 98조의4 미분양주택 요건을 갖춘 경우 양도시기에 관계없이 과세특례(양도세 감면 등)가 적용됩니다.`,
                    (0, D.jsx)(`br`, {}), (0, D.jsx)(`br`, {}),
                    (0, D.jsx)(`strong`, { children: `■ 개정안 : 감면기한 신설` }),
                    (0, D.jsx)(`br`, {}),
                    `- (수도권 아파트) '29.12.31. 까지`,
                    (0, D.jsx)(`br`, {}),
                    `- (수도권아파트 외) '31.12.31. 까지`,
                    (0, D.jsx)(`br`, {}),
                    `※ 단, 조특법 98조의4 비거주자의 미분양주택 과세특례 적용기한은 2028.12.31.로 단축되니 유의 바랍니다.`,
                  ],
                }),
              ],
            }),
            (0, D.jsxs)(`details`, {
              ...
              children: [
                (0, D.jsx)(`summary`, {
                  style: { fontWeight: `600`, cursor: `pointer`, color: `var(--text-main)` },
                  children: `[참고] 고령 1주택자 비수도권 이주 양도세 감면 (개정안)`,
                }),
                (0, D.jsxs)(`div`, {
                  style: { marginTop: `12px`, color: `var(--text-muted)`, lineHeight: `1.6` },
                  children: [
                    (0, D.jsx)(`strong`, { children: `■ 신설 내용` }),
                    (0, D.jsx)(`br`, {}),
                    `수도권에서 5년 이상 거주한 65세 이상인 1주택자가 수도권 주택을 처분 후 6개월 이내 비수도권으로 이주 시 양도세를 감면합니다.`,
                    (0, D.jsx)(`br`, {}), (0, D.jsx)(`br`, {}),
                    `- `, (0, D.jsx)(`strong`, { style: {color: `var(--primary)`}, children: `'27년 50% 감면`}), ` (5억원 한도)`,
                    (0, D.jsx)(`br`, {}),
                    `- `, (0, D.jsx)(`strong`, { style: {color: `var(--primary)`}, children: `'28년 30% 감면`}), ` (3억원 한도)`,
                    (0, D.jsx)(`br`, {}), (0, D.jsx)(`br`, {}),
                    `※ 적용시기: 2027.1.1. 이후 양도분부터`,
                  ],
                }),
              ],
            }),
            (0, D.jsxs)(`details`, {
              ...
              children: [
                (0, D.jsx)(`summary`, {
                  style: { fontWeight: `600`, cursor: `pointer`, color: `var(--text-main)` },
                  children: `[참고] 장기거주공제 전환 보완조치 (개정안)`,
                }),
                (0, D.jsxs)(`div`, {
                  style: { marginTop: `12px`, color: `var(--text-muted)`, lineHeight: `1.6` },
                  children: [
                    `부득이한 사유로 거주를 할 수 없는 주택들에 대해 보유기간을 거주기간으로 인정해주는 특례가 신설됩니다.`,
                    (0, D.jsx)(`br`, {}), (0, D.jsx)(`br`, {}),
                    `- `, (0, D.jsx)(`strong`, { children: `부득이한 사유로 미거주:`}), ` 보유기간을 거주기간으로 인정(최장 3년)`,
                    (0, D.jsx)(`br`, {}),
                    `- `, (0, D.jsx)(`strong`, { children: `특례주택 / 용도변경:`}), ` 특례주택 보유기간(용도변경은 주택외용도 보유기간 합산)을 거주기간으로 인정`,
                    (0, D.jsx)(`br`, {}),
                    `- `, (0, D.jsx)(`strong`, { children: `등록 임대주택:`}), ` 임대기간을 거주기간으로 인정`,
                    (0, D.jsx)(`br`, {}),
                    `- `, (0, D.jsx)(`strong`, { children: `재개발·재건축:`}), ` 공사기간의 50%를 거주기간으로 인정`,
                    (0, D.jsx)(`br`, {}), (0, D.jsx)(`br`, {}),
                    `※ 단, 공제를 산정할 때만 적용되며 비과세를 위한 2년 거주요건에는 미적용`,
                    (0, D.jsx)(`br`, {}),
                    `※ 적용시기: 2028.1.1. 이후 양도분부터`,
                  ],
                }),
              ],
            }),
            (0, D.jsxs)(`div`, {
              ...
              children: [
                (0, D.jsxs)(`button`, {
                  ...
                  onClick: () => {
                    if (!b) return;
                    let e = `[양도소득세 계산 결과 (${f ? `1주택자` : `다주택자`})]\n`;
                    ((e += `- 양도가액: ${S(m)}\n`),
                      (e += `- 취득가액: ${S(h)}\n`),
                      (e += `- 보유기간: ${v}년 / 거주기간: ${y}년\n`),
                      (e += `- 조정지역 취득여부: ${u ? `예` : `아니오`}\n`),
                      (e += nonBusinessLandType > 0 ? `- 비사업용 토지 추가세율: +${nonBusinessLandType === 2 ? 20 : 10}%\n\n` : (!f && surcharge > 0 ? `- 다주택 중과세율: +${surcharge}%\n\n` : `\n`)),
                      (e += f && deductionLimit > 0 ? `- 1주택 장특공제 한도적용: ${deductionLimit/1e8}억\n\n` : ``),
                      (e += `▶ 양도차익: ${S(b.gains)}\n`),
                      (e += `▶ 과세대상 양도차익(9억초과분등): ${S(b.taxableGains)}\n`),
                      (e += `▶ 장기보유특별공제: -${S(b.deduction)} (${b.deductionRate}%)\n`),
                      (e += `▶ 양도소득기본공제: -${S(b.basicDeduction)}\n`),
                      (e += `▶ 과세표준: ${S(b.baseAmount)}\n`),
                      (e += `▶ 산출 양도소득세: ${S(b.tax)}\n`),
                      (e += `▶ 지방소득세: ${S(b.localTax)}\n`),
                      (e += `▶ 총 납부세액: ${S(b.totalTax)}\n`),
                      navigator.clipboard
                        .writeText(e)
                        .then(() => {
                          alert(`계산 결과가 복사되었습니다!`);
...
function me() {
  let [e, t] = (0, _.useState)(`500000000`),
    [n, r] = (0, _.useState)(``),
    [i, a] = (0, _.useState)(`5.0`),
    [o, s] = (0, _.useState)(1),
    [c, l] = (0, _.useState)(!1),
    [u, d] = (0, _.useState)(!1),
    f = parseFloat(e) || 0;
  (0, _.useEffect)(() => {
    r(f > 0 ? (f * 0.7).toString() : `0`);
  }, [e, f]);
  let p = parseFloat(n) || 0,
    m = parseFloat(i) || 0,
    h = (0, _.useMemo)(
      () =>
        f > 0
    ...
    v = (e) => Math.round(e).toLocaleString(`ko-KR`),
    y = (e) => {
      if (!e) return `0원`;
      if (e >= 1e8) {
        let t = Math.floor(e / 1e8),
      ...
      return e >= 1e4 ? `${Math.floor(e / 1e4)}만 원` : `${v(e)}원`;
    };
  return (0, D.jsxs)(`div`, {
    className: `fade-in`,
    children: [
      (0, D.jsxs)(`div`, {
        ...
        children: [
          h ? (0, D.jsxs)('div', {
            style: { marginBottom: '15px', fontSize: '1.05rem', color: 'var(--text-main)', fontWeight: '500' },
            children: ['▶ 총 예상 소요비용: ', (0, D.jsxs)('span', { style: { color: 'var(--primary)', fontWeight: '600' }, children: [y(h.totalExpenses)] })]
          }) : null,
          (0, D.jsxs)(`div`, {
            className: `form-group`,
            children: [
              (0, D.jsx)(`label`, { children: `취득가액 (실거래가)` }),
              (0, D.jsxs)(`div`, {
                className: `input-wrapper`,
                children: [
                  (0, D.jsx)(`input`, {
          ...
          (0, D.jsxs)(`div`, {
            ...
            children: [
              ...
              (0, D.jsx)(`div`, {
                ...
                children: `* 통상 실거래가의 70% 수준으로 자동 입력됩니다. 정확한 계산을 원하시면 공시가격을 직접 입력하세요.`,
              }),
            ],
          }),
          (0, D.jsxs)(`div`, {
            ...
            children: [
              ...
              (0, D.jsx)(`div`, {
                ...
                children: `* 매일 변동되며 통상 4~8% 사이입니다. 은행가서 즉시 매도할 때의 할인율입니다.`,
              }),
            ],
          }),
        ],
            ...
            (0, D.jsxs)(`div`, {
              ...
              children: [
                ...
                (0, D.jsxs)(`div`, {
                  ...
                  children: [
                    ...
                    (0, D.jsx)(`span`, {
                      ...
                      children: y(h.localEducationTax),
                    }),
                  ],
                }),
                (0, D.jsxs)(`div`, {
                ...
                (0, D.jsx)(`div`, {
                  ...
                  children: `※ 위 계산은 단순 예상 금액이므로 실제 부과 금액과 다를 수 있습니다.`,
                }),
              ],
            }),
            (0, D.jsxs)(`div`, {
              ...
              children: [
                (0, D.jsxs)(`button`, {
                  ...
                  onClick: () => {
                    if (!h) return;
                    let e = `[취득세 계산 결과 (${o}주택, ${u ? `85㎡ 초과` : `85㎡ 이하`})]\n`;
                    ((e += `- 취득가액: ${y(f)}\n`),
                      (e += `- 시가표준액(채권매입기준): ${y(p)}\n`),
                      (e += `- 조정지역 여부: ${c ? `예` : `아니오`}\n\n`),
                      (e += `▶ 취득세(${h.taxRate}%): ${y(h.tax)}\n`),
                      (e += `▶ 지방교육세(${h.eduTaxRate}%): ${y(h.eduTax)}\n`),
                      (e += `▶ 농어촌특별세(${h.farmingTaxRate}%): ${y(h.farmingTax)}\n`),
                      (e += `▶ 세금 합계: ${y(h.totalTax)}\n\n`),
                      (e += `▶ 국민주택채권 매입액(서울기준): ${y(h.bondAmount)}\n`),
                      (e += `▶ 채권 할인비용(본인부담): ${y(h.bondDiscountCost)}\n`),
                      (e += `▶ 법무사 수수료(추정치): ${y(h.legalFee)}\n`),
                      (e += `▶ 인지대/증지대 등: ${y(h.stampFee || 15e4)}\n\n`),
                      (e += `▶ 총 예상 소요비용: ${y(h.totalExpenses)}\n`),
                      navigator.clipboard
                        .writeText(e)
                        .then(() => {
                          alert(`계산 결과가 복사되었습니다!`);
  ...
  return (0, D.jsxs)(`div`, {
    ...
    children: [
      (0, D.jsx)(`header`, {
        ...
        children: (0, D.jsxs)(`h1`, {
          children: [
            e === `LOAN` &&
              (0, D.jsxs)(D.Fragment, {
                children: [(0, D.jsx)(ie, { size: 24 }), ` 대출 계산기`],
              }),
            e === `CAPITAL_GAINS` &&
              (0, D.jsxs)(D.Fragment, {
                children: [(0, D.jsx)(ce, { size: 24 }), ` 양도소득세 계산기`],
              }),
            e === `ACQUISITION` &&
              (0, D.jsxs)(D.Fragment, {
                children: [(0, D.jsx)(le, { size: 24 }), ` 취득세 계산기`],
              }),
          ],
        }),
      }),
      (0, D.jsxs)(`div`, {
        ...
        children: [
          (0, D.jsx)(`button`, {
            className: `tab-btn ${e === `LOAN` ? `active` : ``}`,
            onClick: () => t(`LOAN`),
            children: `대출`,
          }),
          (0, D.jsx)(`button`, {
            className: `tab-btn ${e === `CAPITAL_GAINS` ? `active` : ``}`,
            onClick: () => t(`CAPITAL_GAINS`),
            children: `양도세`,
          }),
          (0, D.jsx)(`button`, {
            className: `tab-btn ${e === `ACQUISITION` ? `active` : ``}`,
            onClick: () => t(`ACQUISITION`),
            children: `취득세`,
          }),
        ],
      }),
      (0, D.jsxs)(`main`, {
        ...
        children: [
          e === `LOAN` && (0, D.jsx)(fe, {}),
          e === `CAPITAL_GAINS` && (0, D.jsx)(k, {}),
          e === `ACQUISITION` && (0, D.jsx)(me, {}),
          (0, D.jsx)(`div`, {
            style: {
              textAlign: `center`,
              marginTop: `24px`,
...
(0, v.createRoot)(document.getElementById(`root`)).render(
  (0, D.jsx)(_.StrictMode, { children: (0, D.jsx)(he, {}) }),
);
